...
public class OptionRoue extends Stage {
    ...
    // Vitesse initiale de la roue. Ne modifie pas la position
    // d'arrêt de la roue, uniquement la vitesse d'animation.
    ...
    public OptionRoue() {
        ...
        speedSlider.valueProperty().addListener((o, ov, nv) ->
                lblSpeedVal.setText(String.format("%.2f", nv.doubleValue())));
    ...
    // Méthode statique pour récupérer la vitesse de rotation
